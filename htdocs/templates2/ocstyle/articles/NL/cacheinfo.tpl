...
***************************************************************************}
	...
	<div class="content2-pagetitle">
		<img src="resource2/{$opt.template.style}/images/misc/32x32-tools.png" style="margin-right: 10px;" width="32" height="32" alt="" />Beschrijving voor het maken van een nieuwe cache
	</div>
	<div id="cachedescinfo" class="content-txtbox-noshade" style="padding-right: 25px;">
	
		<p><b>Naam:</b> Kies een passende naam voor de cache die te maken heeft met het cacheonderwerp en de locatie. Gebruik verschillende namen voor verschillende caches.</p>

		<p><b id="cachetype">Cachesoort:</b> Er zijn verschillende soorten om een cache te maken:
		...
		<p><b>Land:</b> In which land is the cache location? This information is important especially for near-border caches.</p>
